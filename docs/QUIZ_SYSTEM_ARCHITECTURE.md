...
CREATE TABLE quiz_sessions (
  ...
  -- Indexes
  INDEX idx_user_sessions (clerk_user_id, created_at DESC),
...
CREATE TABLE quiz_results (
  ...
  -- Indexes
  INDEX idx_user_results (clerk_user_id, completed_at DESC),
...
CREATE TABLE quiz_analytics (
  ...
  INDEX idx_user_analytics (clerk_user_id),
...
CREATE TABLE quiz_recommendations (
  ...
  INDEX idx_user_recommendations (clerk_user_id, status, priority DESC)
);
```
