...
- **Data Layer:** Supabase (PostgreSQL) + Supabase Auth + Real-time subscriptions
...
- **Authentication:** Supabase Auth
  ...
  - Auto-provisioning via database trigger
