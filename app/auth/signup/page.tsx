...
import { Github, Mail, Loader2, User, Check } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        <div className="bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-orange-500/20 p-8 relative z-10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent mb-2">Create Account</h1>
            <p className="text-orange-400">Start your AI-powered learning journey</p>
          </div>
